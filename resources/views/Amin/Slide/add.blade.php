            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tenslider" name="tenslider" value="{{old('tenslider')}}">
                    </div>
                ...
                <div class="col-md-6" style="position: relative;left: 60px">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="sapxep" name="sapxep" min="1" max="10" value="1">
                        </div>

                </div>
            </div>
            <button type="submit" class="btn btn-primary btn-lg" style="margin-top: 20px">Thêm slider</button>
        </form>
    </div>
@endsection
