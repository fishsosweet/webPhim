...
@section('content')
    ...
    <div style="text-align: center; background: linear-gradient(to bottom, #502400, #000); padding: 30px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); max-width: 500px;">
        @if($status===1)
